...
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_design_2_clk_wiz_0_0] -min -add_delay 0.000 [get_ports {leds_4bits_tri_io[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_design_2_clk_wiz_0_0] -max -add_delay 2.000 [get_ports {leds_4bits_tri_io[*]}]
